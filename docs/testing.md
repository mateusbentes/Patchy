...
- The same records expose queue submissions and waits. After the per-tile command-buffer optimization, both values should equal the number of rendered tiles; an idle frame should report zero for both.
